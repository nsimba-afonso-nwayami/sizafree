...
export default function ProfissionaisFarmacia() {
  const [openDetalhes, setOpenDetalhes] = useState(false);

  const dummyProfissionais = [
    {
      id: 301,
      ...
      registro: "CRF 12345",
      status: "Ativo",
      email: "carlos.mendes@farmacia.com",
      telefone: "+244 923456789",
    },
    {
      id: 302,
      nome: "Ana Ribeiro",
      funcao: "Técnica de Farmácia",
      especialidade: "Dispensação de Medicamentos",
      registro: "CRF 67890",
      status: "Ativo",
      email: "ana.ribeiro@farmacia.com",
      telefone: "+244 923456780",
    },
    {
      id: 303,
      nome: "Paulo Lima",
  ...
  return (
    <>
      <title>Profissionais | Dashboard Farmácia</title>

      <FarmaciaLayout title="Profissionais">
        {/* FILTROS */}
          ...
          {dummyProfissionais.map((prof) => (
            ...
            >
              <div className="flex justify-between items-center mb-2">
                <div>
                  <p className="font-semibold text-teal-800">{prof.nome}</p>
                  <p className="text-slate-500 text-sm">
                    {prof.funcao} • {prof.especialidade}
                  </p>
                </div>
              ...
              <p className="text-slate-600 text-sm">
                Registro: <span className="font-medium">{prof.registro}</span>
              </p>
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="bg-teal-50 border border-teal-200 rounded-xl p-6">
              ...
              <p className="text-slate-500">
                Farmacêutico Responsável • Farmácia Clínica
              </p>
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="font-semibold text-slate-800">CRF 12345</p>
              </div>

              <div>
                <p className="text-sm text-slate-500">E-mail</p>
                <p className="font-semibold text-slate-800">
                  carlos.mendes@farmacia.com
                </p>
              </div>
