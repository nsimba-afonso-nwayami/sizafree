          ...
          <tbody>
            {dummyHistorico.map((item) => (
              ...
              >
                ...
                <td className="p-3 whitespace-nowrap">{item.especialidade}</td>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
            <div className="bg-slate-50 border border-teal-200 rounded-xl p-5">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-sm text-slate-500">Data da Consulta</span>
              </div>
              <p className="text-lg font-semibold text-slate-800">10/11/2025</p>
            </div>
            ...
            <div className="bg-slate-50 border border-teal-200 rounded-xl p-5">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-sm text-slate-500">Unidade de Saúde</span>
              </div>
              <p className="text-lg font-semibold text-slate-800">
          ...
          <div className="bg-teal-50 border border-teal-200 rounded-xl p-6">
            ...
            <p className="text-slate-700 leading-relaxed">
              Paciente apresentou evolução clínica positiva, sem intercorrências
