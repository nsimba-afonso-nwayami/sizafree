...
export default function HeaderHospital({ sidebarOpen, setSidebarOpen, title }) {
  return (
    <header
      className="
        bg-teal-800
    ...
    >
      ...
      <div className="flex items-center gap-4">
        <Link to="/dashboard/hospital/notificacoes" className="relative text-xl text-white hover:text-teal-200 transition">
