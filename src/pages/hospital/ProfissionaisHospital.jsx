...
export default function ProfissionaisHospital() {
  ...
  const dummyProfissionais = [
    ...
    },
    {
      ...
      crm: "CRM 67890",
      status: "Ativo",
      email: "ana.ribeiro@hospital.com",
  ...
  return (
    <>
      <title>Profissionais | Dashboard Hospital</title>

      <HospitalLayout title="Profissionais">
        {/* FILTROS */}
          ...
          {dummyProfissionais.map((prof) => (
            ...
            >
              ...
              <p className="text-slate-600 text-sm">
                Registro: <span className="font-medium">{prof.crm}</span>
              </p>
        ...
        >
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="bg-teal-50 border border-teal-200 rounded-xl p-6">
              ...
              <p className="text-slate-500">Médico • Clínica Geral</p>
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="font-semibold text-slate-800">CRM 12345</p>
              </div>

              <div>
                <p className="text-sm text-slate-500">E-mail</p>
                <p className="font-semibold text-slate-800">
                  carlos.mendes@hospital.com
                </p>
              </div>
