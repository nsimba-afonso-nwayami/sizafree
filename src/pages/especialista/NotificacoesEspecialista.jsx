...
export default function NotificacoesEspecialista() {
  ...
  const notificacoes = [
    {
      ...
      tipo: "Consulta",
      descricao:
        "A consulta com João da Silva foi confirmada para 20/01/2026 às 10:00.",
      data: "18/01/2026",
    ...
    },
    {
      ...
      tipo: "Prescrição",
      descricao:
        "Uma nova prescrição foi solicitada pelo paciente Maria Oliveira.",
      data: "19/01/2026",
    ...
    },
    {
      id: 3,
      tipo: "Documento",
      descricao: "Carlos Santos adicionou novos exames para análise.",
      data: "15/01/2026",
  ...
  return (
    <>
      <title>Notificações | Dashboard Especialista</title>

      <EspecialistaLayout title="Notificações">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm mb-6">
          ...
          <p className="text-slate-500 mb-6">
            Gerencie quais tipos de notificações deseja receber no sistema.
          </p>
          ...
          <div className="grid gap-4">
            ...
            <div className="flex justify-between items-center border-b border-slate-200 pb-3">
              <div>
                ...
                <p className="text-sm text-slate-500">
                  Alertas sobre confirmações, cancelamentos e novas consultas
                </p>
              </div>
            ...
            <div className="flex justify-between items-center border-b border-slate-200 pb-3">
              <div>
                ...
                <p className="text-sm text-slate-500">
                  Avisos sobre prescrições criadas ou solicitadas
                </p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-sm text-slate-500">
                  Seja avisado quando pacientes enviarem novos documentos
                </p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
